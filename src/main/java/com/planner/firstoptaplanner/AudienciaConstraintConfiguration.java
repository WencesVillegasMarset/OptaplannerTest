...
@ConstraintConfiguration(constraintPackage = "resources")
public class AudienciaConstraintConfiguration extends AbstractPersistable {
    ...
    public AudienciaConstraintConfiguration() {
    }

    public AudienciaConstraintConfiguration(long id) {
        super(id);
    }
